...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        /*ImageView iv = (ImageView) findViewById(R.id.header_parallax_travel_image);
        ...
        /*final View menuView = getLayoutInflater().inflate(
                R.layout.header_parallax_travel, mDrawerList, false
        );*/
		...
		mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, toolbar,
			...
			public void onDrawerClosed(View view) {
				getSupportActionBar().setTitle(mTitle);
                startActivity(new Intent(MainActivity.this, ParallaxTravelActivity.class));
	...
	//change to go to different pages
	private class DrawerItemClickListener implements
			ListView.OnItemClickListener {
		@Override
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			switch(position) {
                case 0:
                    Intent newActivity0 = new Intent(MainActivity.this, LogInPageActivity.class);
                    startActivity(newActivity0);
                    break;
				case 1:
					Intent newActivity1 = new Intent(MainActivity.this, SearchBarShopActivity.class);
					startActivity(newActivity1);
					break;
				case 2:
					Intent newActivity2 = new Intent(MainActivity.this, ExpandableListViewActivity.class);
					startActivity(newActivity2);
					break;
                case 3:
                    Intent newActivity3 = new Intent(MainActivity.this, DragAndDropTravelActivity.class);
                    startActivity(newActivity3);
                    break;
			}
			/*if (position == 1) {
				Intent intent = new Intent(MainActivity.this, SearchBarMediaActivity.class);
				//String itemClicked = mDrawerItems[position];
				//intent.putExtra();
				startActivity(intent);
			} else if (position == 2) {
				Intent intent2 = new Intent(MainActivity.this, DragAndDropTravelActivity.class);
