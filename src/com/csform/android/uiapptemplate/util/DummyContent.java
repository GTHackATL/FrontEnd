...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getDummyModelList() {
		...
		list.add(new DummyModel(0, "http://pengaja.com/uiapptemplate/newphotos/profileimages/0.jpg", "Atlanta", R.string.fontello_heart_empty));
		list.add(new DummyModel(1, "http://pengaja.com/uiapptemplate/newphotos/profileimages/1.jpg", "Los Angeles", R.string.fontello_heart_empty));
		list.add(new DummyModel(2, "http://pengaja.com/uiapptemplate/newphotos/profileimages/2.jpg", "New York", R.string.fontello_heart_empty));
		list.add(new DummyModel(3, "http://pengaja.com/uiapptemplate/newphotos/profileimages/3.jpg", "San Francisco", R.string.fontello_heart_empty));
		list.add(new DummyModel(4, "http://pengaja.com/uiapptemplate/newphotos/profileimages/4.jpg", "Manhattan", R.string.fontello_heart_empty));
		list.add(new DummyModel(5, "http://pengaja.com/uiapptemplate/newphotos/profileimages/5.jpg", "Shanghai", R.string.fontello_heart_empty));
		list.add(new DummyModel(6, "http://pengaja.com/uiapptemplate/newphotos/profileimages/6.jpg", "Beijing", R.string.fontello_heart_empty));
		list.add(new DummyModel(7, "http://pengaja.com/uiapptemplate/newphotos/profileimages/7.jpg", "Chengdu", R.string.fontello_heart_empty));
		list.add(new DummyModel(8, "http://pengaja.com/uiapptemplate/newphotos/profileimages/8.jpg", "Suzhou", R.string.fontello_heart_empty));
		list.add(new DummyModel(9, "http://pengaja.com/uiapptemplate/newphotos/profileimages/9.jpg", "Hong Kong", R.string.fontello_heart_empty));
		list.add(new DummyModel(10, "http://pengaja.com/uiapptemplate/newphotos/profileimages/10.jpg", "Toronto", R.string.fontello_heart_empty));
		list.add(new DummyModel(11, "http://pengaja.com/uiapptemplate/newphotos/profileimages/11.jpg", "Houston", R.string.fontello_heart_empty));
		list.add(new DummyModel(12, "http://pengaja.com/uiapptemplate/newphotos/profileimages/12.jpg", "Washington", R.string.fontello_heart_empty));
		list.add(new DummyModel(13, "http://pengaja.com/uiapptemplate/newphotos/profileimages/13.jpg", "San Diego", R.string.fontello_heart_empty));
		list.add(new DummyModel(14, "http://pengaja.com/uiapptemplate/newphotos/profileimages/14.jpg", "Las Vegas", R.string.fontello_heart_empty));
		list.add(new DummyModel(15, "http://pengaja.com/uiapptemplate/newphotos/profileimages/15.jpg", "Boston", R.string.fontello_heart_empty));
	...
	public static ArrayList<DummyModel> getDummyModelListTravel() {
		...
		list.add(new DummyModel(1, "", "Good Bookstore", R.string.fontello_heart_empty));
		list.add(new DummyModel(2, "", "Express Hotel", R.string.fontello_heart_empty));
		list.add(new DummyModel(3, "", "Mine Cafe", R.string.fontello_heart_empty));
		list.add(new DummyModel(4, "", "Love Flower Shop", R.string.fontello_heart_empty));
		list.add(new DummyModel(5, "", "Story Apartment", R.string.fontello_heart_empty));
	...
	public static ArrayList<DummyModel> getTravelDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Set Stops and Time", R.string.material_icon_go));
		list.add(new DummyModel(1, "", "Results", R.string.material_icon_bookmark));
		//list.add(new DummyModel(2, "", "Where To Go", R.string.material_icon_check));
